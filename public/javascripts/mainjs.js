...
$(function () {
  const mainSocket = io("http://localhost:4200", {
    path: "/socket.io",
    transports: ["polling"],
    transportOptions: {
      polling: {
  ...
  function allState() {
    $.getJSON("http://localhost:4200/state/all", function (data) {
      parseAll(data);
  ...
  $("#poolTempOnOff").on("click", function (e) {
    ...
    $.ajax({
      type: "PUT",
      url: "http://localhost:4200/state/body/heatMode",
  ...
  function setPool(data) {
    $.ajax({
      type: "PUT",
      url: "http://localhost:4200/state/circuit/setState",
      contentType: "application/json; charset=utf-8",
      dataType: "json",
  ...
  function setPoolCond(data) {
    $.ajax({
      type: "PUT",
      url: "http://localhost:4200/state/body/setPoint",
      contentType: "application/json; charset=utf-8",
      dataType: "json",
      data: JSON.stringify(data),
